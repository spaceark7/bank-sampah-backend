...
const UserCitizenSchema = yup.object({
  ...
  gender: yup.string().oneOf(['Male', 'Female'], 'Jenis kelamin tidak valid').required('Jenis kelamin tidak boleh kosong'),
  ...
  marital_status: yup
    .string()
    .oneOf(['Single', 'Married', 'Divorced', 'Widowed'], 'Status pernikahan tidak valid')
